...
personal appearance, race, caste, color, religion, or sexual identity
and orientation.
...
issues, pull requests, discussions, and any other channel the
project uses — and also applies when an individual is officially
representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior
may be reported to the project maintainer via GitHub's private
[vulnerability reporting flow](https://github.com/GoldAnTo/fund-data/security/advisories/new)
or the email address in `SECURITY.md`. All complaints will be
